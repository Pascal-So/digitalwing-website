$(function(){
	...
	var aboutDWList = "<table>" +
			...
			"<tr><td>November</td><td class='centerTd'>Seelandindoorcycling 2016</td><td><a class='aboutLink ytLink' href='#about' target='' id='cyaQJswTQCM' aspect='45.0%'><img src='img/playIcon.svg' class='aboutPlay'>&nbsp;Anschauen</a></td></tr>" +
			"<tr><td>November</td><td class='centerTd'>Musikvideo <q>Waves</q></td><td><a class='aboutLink ytLink' href='#about' target='' id='hzR74WpFa4Q' aspect='45.0%'><img src='img/playIcon.svg' class='aboutPlay'>&nbsp;Anschauen</a></td></tr>" +
			"<tr><td>Oktober</td><td class='centerTd'>Skye am Cybathlon 2016</td></tr>" + 
			"<tr><td>April</td><td class='centerTd'>Promo für Skye von Aerotainment Labs</td><td><a class='aboutLink ytLink' href='#about' target='' id='DszwR1-fmLs' aspect='34.4%'><img src='img/playIcon.svg' class='aboutPlay'/>&nbsp;Anschauen</a></td></tr>" +
			"<tr><td>Februar</td><td class='centerTd'>Musikvideo <q>Fly</q> (4K)</td><td><a class='aboutLink ytLink' href='#about' target='' id='NL3joKd7P-A' aspect='34.4%'><img src='img/playIcon.svg' class='aboutPlay'/>&nbsp;Anschauen</a></td></tr>" +
			"<tr><th>2015</th></tr>" +
			"<tr><td>Dezember</td><td class='centerTd'>Kurzvideo für Aerotainment an der UZH</td></tr>" +
			"<tr><td>November</td><td class='centerTd'>Promo Seelandindoorcycling</td><td><a class='aboutLink ytLink' href='#about' target='' id='RFJGh29AScw' aspect='45.0%'><img src='img/playIcon.svg' class='aboutPlay'/>&nbsp;Anschauen</a></td></tr>" +
			"<tr><td>September</td><td class='centerTd'>Mittelaltermarkt Kiesen</td><td><a class='aboutLink ytLink' href='#about' target='' id='41R56juAyfA' aspect='45.0%'><img src='img/playIcon.svg' class='aboutPlay'/>&nbsp;Anschauen</a></td></tr>" +
			"</table>";
