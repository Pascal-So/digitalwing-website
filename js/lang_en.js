$(function(){
	...
	var projectColumn0Text = "Whether it's a commercial you're planning, a concert, a music video or just about any other event, we're looking forward to working with you. Our process begins with an initial conversation with you, during which we'll note down your basic expectations and conditions. With that information we'll create an individual offer. Of course we'll stay in direct contact during the realization of your project. <br><br>Go ahead and send us an <span class='email'>email</span> to get started!";
